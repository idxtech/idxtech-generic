...
@Constraint(checkWith = IdCardNumberCheck.class)
public @interface IdCardNumber {
     ...
     */
    String errorCode() default "com.mljr.lease.merchant.api.constraint.IdCardNumber";
     ...
     */
    String message() default "{context} is not valid ID card number";
