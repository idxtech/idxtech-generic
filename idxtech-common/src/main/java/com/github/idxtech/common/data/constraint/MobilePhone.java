...
@Constraint(checkWith = MobilePhoneCheck.class)
public @interface MobilePhone {
     ...
     */
    String errorCode() default "com.mljr.lease.merchant.api.constraint.MobilePhone";
     ...
     */
    String message() default "{context} is not valid mobile phone";
